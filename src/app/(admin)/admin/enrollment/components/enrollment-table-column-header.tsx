...
interface EnrollmentTableColumnHeaderProps<TData, TValue>
  extends React.HTMLAttributes<HTMLDivElement> {
  column: Column<TData, TValue>;
  title: string;
}

export function EnrollmentTableColumnHeader<TData, TValue>({
  column,
  title,
  className,
}: EnrollmentTableColumnHeaderProps<TData, TValue>) {
